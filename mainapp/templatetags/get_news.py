...
if r.ok:  # 200  ## 403 404
    ...
    link_containers = soup.findAll("div", {"class": "zmainCard_item card_md z-col-lg-3 z-col-md-3"})
    # print(titles)
    counter = 0
    links_list = []
...
titl_time = titles.replace("\n", "_")[42:].replace("_" * 11, "_").replace("__", "_").split("_")[:46]
# print(titles)
